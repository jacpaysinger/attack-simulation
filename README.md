...
Next I generate failed RDP logs by completing the following steps:
  - From `attack-vm`, I attempt to RDP into `windows-vm` using incorrect credentials.
  - I repeat this step two more times with different incorrect usernames and passwords.
...
I then generate failed MS SQL authentication logs by attempting to connect to SQL Server on `windows-vm` using an incorrect password<img width="786" alt="Screenshot 2025-02-23 at 2 06 08 AM" src="https://github.com/user-attachments/assets/1c7cd4f1-ce78-4efe-9683-83cc7cc7e290" />

Lastly, I generate failed SSH logs for into the Linux VM by attempting to SSH into `linux-vm` from `attack-vm` using incorrect credentials.<img width="677" alt="Screenshot 2025-02-23 at 4 08 32 PM" src="https://github.com/user-attachments/assets/942297d2-67ef-4d2e-a7a7-40fed1138592" />


### 3. Admin Mode (Investigating Logs)
I inspect the security logs on the Windows VM by completing the following steps:
...
<img width="1210" alt="Screenshot 2025-02-23 at 3 59 09 AM" src="https://github.com/user-attachments/assets/2147077c-9b10-45cd-b4e6-ac76d1005c97" />
<img width="1210" alt="Screenshot 2025-02-23 at 3 36 07 AM" src="https://github.com/user-attachments/assets/9bd2dd34-8d16-42ad-b6fc-44503b498a71" />

Next I inspect authentication logs on the Linux VM:
  - SSH into `linux-vm`.
  - Use the following commands to analyze authentication logs by completing the following steps:
```powershell
